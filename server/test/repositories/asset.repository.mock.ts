...
export const newAssetRepositoryMock = (): Mocked<RepositoryInterface<AssetRepository>> => {
  return {
    ...
    getExistingChecksums: vitest.fn().mockResolvedValue(new Set()),
    getExternalLibraryChecksumBackfillPage: vitest.fn(),
    getExternalLibraryPathChecksumBackfillPage: vitest.fn(),
    getLivePhotoCount: vitest.fn(),
    getLibraryAssetCount: vitest.fn(),
    updateAll: vitest.fn(),
    updateChecksum: vitest.fn(),
    updateAllExternalToPathHash: vitest.fn(),
    getByLibraryIdAndOriginalPath: vitest.fn(),
    deleteAll: vitest.fn(),
    update: vitest.fn(),
    remove: vitest.fn(),
    findLivePhotoMatch: vitest.fn(),
    findOhosLivePhotoMatch: vitest.fn(),
