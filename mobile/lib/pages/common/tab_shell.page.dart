  ...
  Widget build(BuildContext context) {
    ...
    final navigationDestinations = [
      ...
      NavigationDestination(
        ...
        selectedIcon:
            Icon(Icons.photo_album_rounded, color: context.primaryColor),
      ),
      NavigationDestination(
        label: 'library'.tr(),
        ...
        return PopScope(
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: _BottomNavigationBar(
                tabsRouter: tabsRouter, destinations: navigationDestinations),
          ),
        );
      },
    );
...
class _BottomNavigationBar extends ConsumerWidget {
  const _BottomNavigationBar(
      {required this.tabsRouter, required this.destinations});
