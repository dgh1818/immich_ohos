...
String _$videoPlayerControllerHash() =>
    r'060785aa4e875fdfe73205349d84a2890b85437f';
...
class VideoPlayerControllerFamily
  ...
  /// See also [videoPlayerController].
  VideoPlayerControllerProvider call({required Asset asset}) {
    return VideoPlayerControllerProvider(asset: asset);
  }
...
class VideoPlayerControllerProvider
  ...
  /// See also [videoPlayerController].
  VideoPlayerControllerProvider({required Asset asset})
    : this._internal(
